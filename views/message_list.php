...
<?php include '../db_connection.php';
    ...
    $result = mysqli_query($connection, "SELECT * FROM `fc_user_messages`");
                    ...
                    <div class="col-md-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                ...
                                <li class='active'><a href="/message_list">Message List</a></li>
                            </ul>
                        </nav><!-- / #primary-nav -->
                    </div>
                </div>
    ...
    <main>
        <section class="our-services">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 style="color:green;"><b> Message List </b></h2> 
                        <p> Use reply button to reply each message...... </p>                        
                    </div>
                </div>
            </div>
        </section>   
                    ...
                    <div class="col-md-12">
                      <!-- Display table data. -->
                        ...
                        <tr style="border-bottom: 3px solid #807E7D;">
                            ...
                            <th style="padding-bottom:5px;">Customer Name</th>
                            <th style="padding-bottom:5px;">Subect</th>
                            <th style="padding-bottom:5px;">Message</th>
                            <th style="padding-bottom:5px;">Received Date</th>
