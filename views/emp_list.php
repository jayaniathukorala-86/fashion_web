                    ...
                    <div class="col-md-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                ...
                                <li class='active'><a href="/emp_list">Uses List</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <p> Use Edit button to edit each employee detail...... </p>                        
                    </div>
                    <div class="col-md-2">
                        <div class="blue-button">
                            <a href="/add_user">Add Employee</a>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                       ...
                       <table class="col-md-12">
                        <tr style="border-bottom: 3px solid #807E7D;">
                            ...
                            <th style="padding-bottom:5px;">Employee Name</th>
